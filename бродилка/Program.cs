namespace HodimBrodim
{
    class GovnoCode
    {
            ...
            while (wannaPlay == true)
            {
                ...
                switch (EnemyCount)
                {
                    case "2":
                        ...
                        EnemyBehavior(map, ref EnemyX0, ref EnemyY0);
                        EnemyBehavior(map, ref EnemyX1, ref EnemyY1);
                        break;
                    case "4":
                        PreviousEnemyX1 = EnemyX1;
                        PreviousEnemyY1 = EnemyY1;
                        ...
                        EnemyBehavior(map, ref EnemyX0, ref EnemyY0);
                        EnemyBehavior(map, ref EnemyX1, ref EnemyY1);
                        EnemyBehavior(map, ref EnemyX2, ref EnemyY2);
                        EnemyBehavior(map, ref EnemyX3, ref EnemyY3);
                        break;
                    case "6":
                        PreviousEnemyX1 = EnemyX1;
                        PreviousEnemyY1 = EnemyY1;
                        ...
                        EnemyBehavior(map, ref EnemyX2, ref EnemyY2);
                        EnemyBehavior(map, ref EnemyX3, ref EnemyY3);
                        EnemyBehavior(map, ref EnemyX4, ref EnemyY4);
                        EnemyBehavior(map, ref EnemyX5, ref EnemyY5);
                        break;
        ...
        static void EnemyBehavior(char[,] map, ref int EnemyY, ref int EnemyX)
        {
